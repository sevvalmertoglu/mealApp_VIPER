...
//  
//
//  Created by Şevval Mertoğlu on 8.09.2023.
//

import Alamofire
import Foundation

public typealias Completion<T> = (Result<T, APIClientError>) -> Void where T: Decodable //T sadece decodable olanlarda çalışacak
