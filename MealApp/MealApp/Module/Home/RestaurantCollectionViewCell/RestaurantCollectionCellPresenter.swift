...
//  MealApp
//
//  Created by Şevval Mertoğlu on 23.03.2024.
//
...
final class RestaurantCollectionCellPresenter {
    ...
    init(view: RestaurantCollectionViewCellInterface?, restaurant: Restaurant) {
        self.view = view
    ...
    private func setCampaignView() {
        if let campaingText = restaurant.campaignText, !campaingText.isEmpty {
            view?.prepareCampaingView(campaingText: campaingText)
